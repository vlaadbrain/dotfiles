		...
		vim.api.nvim_create_autocmd("LspAttach", {
			...
			callback = function(event)
				...
				if client and client:supports_method(vim.lsp.protocol.Methods.textDocument_documentHighlight) then
					local highlight_augroup = vim.api.nvim_create_augroup("grayhat-lsp-highlight", { clear = false })
					...
					vim.api.nvim_create_autocmd("LspDetach", {
						group = vim.api.nvim_create_augroup("grayhat-lsp-detach", { clear = true }),
		...
		if vim.loop.os_uname().sysname ~= "FreeBSD" then
			...
			servers.clangd = {
				...
				on_attach = function(client, bufnr)
					...
					client.server_capabilities.semanticHighlighting = true
