...
vim.keymap.set("n", "<leader>pf", function() telescope.git_files(tt.get_dropdown({ winblend = 10})) end, { desc = "Project (git) search" })
vim.keymap.set("n", "<leader>ps", function() telescope.git_status() end, { desc = "Project (git) status" })

vim.keymap.set("n", "<leader>a", function() harpoon:list():add() end, { desc = "Harpoon add file" })
vim.keymap.set("n", "<C-e>", function() harpoon.ui:toggle_quick_menu(harpoon:list()) end, { desc = "Harpoon window" })
vim.keymap.set("n", "<C-1>", function() harpoon:list():select(1) end, { desc = "Harpoon show 1st Buffer" })
vim.keymap.set("n", "<C-2>", function() harpoon:list():select(2) end, { desc = "Harpoon show 2nd Buffer" })
vim.keymap.set("n", "<C-3>", function() harpoon:list():select(3) end, { desc = "Harpoon show 3rd Buffer" })
vim.keymap.set("n", "<C-4>", function() harpoon:list():select(4) end, { desc = "Harpoon show 4th Buffer" })
